            	...
            	<?php echo form_open('#',array('class' => 'form-horizontal')); ?>
	              ...
	              <div class="box-body text-left">
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-9">
	                    <input type="text" class="form-control" name="tahun_akademik" value="" id="inputEmail3" placeholder="Tahun Akademik ex:2018-2019">
	                  </div>
	                </div>
	                <div class="form-group">
	             	...
	             	<div class="form-group">
	                  ...
	                  <div class="col-sm-9">
	                    <input type="text" class="form-control" name="kurikulum" id="inputEmail3" placeholder="Tahun Akademik ex:2018-2019">
	                  </div>
	                </div>
	              <!-- /.box-body -->
	             <div class="box-footer pull-right">
	              	<a href="<?php echo site_url('dashboard/akademik') ?>" class="btn btn-danger ">Batal</a>
	                <button type="button" class="btn btn-info " disabled>Simpan</button>
	              </div>
	              <!-- /.box-footer -->
              	<?php echo form_close(); ?>
            </div>
