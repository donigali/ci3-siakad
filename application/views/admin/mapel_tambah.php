<div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah data Mapel</li>
      </ol>
    </section>
	<br>
    <!-- Main content -->
    <section class="content">
    	<div class="box box-success box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            	<?php echo form_open(site_url('dashboard/mapel_add_proses'),array('class' => 'form-horizontal')); ?>
	              ...
	              <div class="box-body text-left">
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-9">
	                    <input type="text" class="form-control" name="nama_mapel" value="" id="inputEmail3" placeholder="Nama Mata Pelajaran">
	                  </div>
	                </div>
	                <div class="form-group">
