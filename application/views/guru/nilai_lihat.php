    ...
    <section class="content">
    	...
    	<div class="box box-success box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Lihat Nilai siswa kelas - <?php if(isset($kelas)) echo $kelas; ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
            <?php echo form_open(site_url('guru/lihat_nilai/'.$this->uri->segment(3))); ?>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="id_mapel" class="form-control" id="">
                            ...
                            <?php foreach ($mapel as $a) { ?>
                                <option value="<?php echo $a->id_mapel ?>" <?php if($mapel_id->id_mapel == $a->id_mapel) echo 'selected'; ?>><?php echo $a->nama_mapel ?></option>
                            <?php } ?>
                        </select>
                ...
                <br>
	             	...
	             	<table class="table table-bordered text-center" id="tabel_siswa" dataTables_filter="10">
    					...
    					<tbody>
                            ...
                            <?php $no=1; foreach($raport->result() as $data): ?>
                            <input type="hidden" class="form-control" name="id_nilai[]" value="<?php echo $data->id_nilai; ?>">
                                <tr>
                                    <th width="2%">#</th>
                                    ...
                                    <th width="4%"><input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="nilai_uh[]" value ="<?php echo $data->rata_rata_nilai_ulangan_harian; ?>" data-id="<?php echo $data->id_siswa; ?>" id="uh<?php echo $data->id_siswa; ?>"></th>
                                    <th width="4%"><input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="nilai_tugas[]" value ="<?php echo $data->rata_rata_nilai_tugas; ?>" data-id="<?php echo $data->id_siswa; ?>" id="tugas<?php echo $data->id_siswa; ?>"></th>
                                    <th width="4%"><input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="nilai_uts[]" value ="<?php echo $data->nilai_uts; ?>" data-id="<?php echo $data->id_siswa; ?>" id="uts<?php echo $data->id_siswa; ?>"></th>
                                    <th width="4%"><input type="text" class="form-control" onkeypress="return hanyaAngka(event)" name="nilai_uas[]" value ="<?php echo $data->nilai_uas; ?>" data-id="<?php echo $data->id_siswa; ?>" id="uas<?php echo $data->id_siswa; ?>"></th>
                                    <th width="4%"><input type="text" class="form-control" name="nilai_akhir[]" data-id="<?php echo $data->id_siswa; ?>" value ="<?php echo $data->nilai_akhir; ?>" id="total<?php echo $data->id_siswa; ?>" readonly></th>
                                    <th width="4%"><input type="text" class="form-control" name="predikat[]" data-id="<?php echo $data->id_siswa; ?>" value ="<?php echo $data->predikat; ?>" id="predikat<?php echo $data->id_siswa; ?>" readonly></th>
                                    <th width="5%"><input type="text" class="form-control" name="keterangan[]" data-id="<?php echo $data->id_siswa; ?>" value ="<?php echo $data->keterangan; ?>" id="keterangan<?php echo $data->id_siswa; ?>" readonly></th>
                                </tr>
                            <?php endforeach ?>
                    ...
                    <button class="btn btn-success">Update Nilai Siswa</button>
                <?php echo form_close(); ?>
            <?php }else{ ?>
                <table class="table table-bordered text-center" id="tabel_siswa" dataTables_filter="10">
    					<thead>
    					...
    					<tbody>
                            <td colspan="9"><h3>Tidak Ada Data</h3></td>
    					</tbody>
    				</table>
